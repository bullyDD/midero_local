...
package body Motor is
   ...
   Internal_Power : constant Power_Level := 50;       -- Default motor power level value
   ...
   -- Run --
   ---------
   procedure Run (This : in out Basic_Motor) is
   begin
      if not Set (This.H_Bridge1) then
         This.Set_Motor (ON);
      else   
         null;
      end if;
