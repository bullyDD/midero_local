...
package Sequential_Bounded_Buffers is
    --pragma Unevaluated_Used_Of_Old (Allow);
    ...
    procedure Copy (Source : Ring_Buffer; Target : in out Ring_Buffer) 
        with
    ...
    procedure Put (This : in out Ring_Buffer; Item : Element);
        --  with
    ...
    procedure Get (This : in out Ring_Buffer; Item : out Element);
        --  with
        --      Pre    => not Empty (This),
        --      Post   => not Full (This)
    ...
    procedure Reset (This : out Ring_Buffer);
        --  with
        --      Post   =>   Empty (This) and
        --                  Extent (This) = 0 and
        --                  Model (This)'Length = 0,
    ...
    procedure Delete (This : in out Ring_Buffer;  Count : Buffer_Size) ;
        --with
